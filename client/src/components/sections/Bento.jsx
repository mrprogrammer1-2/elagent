...
const Show = () => {
  ...
  return (
    <section
      className={`w-full py-8 sm:py-10 md:py-40 pt-20 bg-gradient-to-br from-slate-800 to-slate-900 ${
        isRTL ? "rtl" : "ltr"
      }`}
    >
      <div className="space-y-2 text-center mb-6">
        ...
        <p className="text-xl text-gray-300">{t("home.fashionSubtitle")}</p>
      </div>
      ...
      <Container className={"bento"}>
        ...
        <div className="item-1 rounded-lg overflow-hidden relative">
          ...
          <div
            ...
            } top-0 w-[80%] max-w-[300px] pt-4 md:pt-6 lg:pt-8 xl:pt-10 2xl:pt-12 font-poppins`}
          >
            <h3 className="text-black text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-3xl font-semibold mb-1 sm:mb-2">
        ...
        <div className="item-2 rounded-lg overflow-hidden relative">
          ...
          <div
            className={`absolute ${
              isRTL ? "right-4" : "left-4"
            } top-0 w-[80%] max-w-[300px] pt-4 md:pt-6 lg:pt-8 xl:pt-10 2xl:pt-12`}
          >
            <h3 className="text-black text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-3xl font-semibold mb-1 sm:mb-2">
              {t("home.newArrivals")}
            </h3>
